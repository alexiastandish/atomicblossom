...
export default async function page(props) {
  ...
  return (
    <div className=" flex flex-col xl:bg-yellow-500 lg:bg-green-500 md:bg-blue-500 sm:bg-red-500">
      <section className="h-screen hero flex items-center justify-center ">
        <div className="hero-content lg:text-left lg:flex-row sm:max-md:flex-col flex-col text-center justify-between p-12">
          <div className="flex flex-col lg:items-start	md:items-center sm:items-center  w-1/2">
            <OverlayText
              textSize={8}
              textColor="primary"
              style={{ fontSize: "3em" }}
    ...
    dark:[&::-webkit-scrollbar-thumb]:bg-primary"
      ...
      <section className=" hero  min-h-screen  bg-white flex items-center justify-center ">
        <div className="hero-content flex-col text-center p-12">
